"use strict";function asyncGeneratorStep(e,n,s,t,a,c,i){try{var r=e[c](i),o=r.value}catch(e){return void s(e)}r.done?n(o):Promise.resolve(o).then(t,a)}function _asyncToGenerator(e){return function(){var n=this,s=arguments;return new Promise((function(t,a){var c=e.apply(n,s);function i(e){asyncGeneratorStep(c,t,a,i,r,"next",e)}function r(e){asyncGeneratorStep(c,t,a,i,r,"throw",e)}i(void 0)}))}}$((function(){$("header");var e,n,s=$("body").attr("id"),t=$(".header .header-content"),a=$(".lower-header"),c=$(".upper-header"),i=$(".hamburger-icon"),r=$(".lower-header .nav-item .nav-link"),o=$(".link-search"),l=$("#menu .nav-list a"),d=$("#menu"),u=($(".out-lcontainer"),$(".home-products-li"),$(".product-select"),!1);function p(){n=t.innerHeight(),a.innerHeight(),c.innerHeight(),d.innerWidth(),d.innerWidth()}function m(){p(),d.css("top",n)}function v(){p(),$("body").css("padding-top",n),window.innerWidth<768&&(!u&&(u=!0,$("#menu").multilevelpushmenu({container:$("#menu"),collapsed:!0,menuWidth:"100%",overlapWidth:0,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:"",preventItemClick:!0,preventGroupItemClick:!0,direction:"ltr",fullCollapse:!0,swipe:"none"})),$("#menu").multilevelpushmenu("redraw"),m())}r.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),l.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),d.toggleClass("expand"),$("#menu").hasClass("expand")?$("#menu").multilevelpushmenu("expand"):$("#menu").multilevelpushmenu("collapse"),$(this).find(".icon").hasClass("fa-arrow-left")?o.fadeOut(100):o.fadeIn(100)}));var g=$(".colors-types .slick-slider");function f(e,n){e.slick({slidesToShow:n,slidesToScroll:1,arrows:!1,dots:!1,cssEase:!0,infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:2.5}},{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:1.5,slidesToScroll:1}}]})}function h(e,n){return k.apply(this,arguments)}function k(){return(k=_asyncToGenerator(regeneratorRuntime.mark((function e(n,t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,t.map((function(e){var t=e.src,a=e.name,c=e.mark,i=e.type,r='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'><img class="img" src='.concat(t,"   alt=").concat(a,'></div>\n            <div class="card-body">\n            <a href="#" class="card-title name link">').concat(a,'</a>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle type">').concat(i,'</h6>\n              <p class="desc">').concat(c,"</p>\n            </div>\n           \n          \n            <div class='cart icon'><img src=").concat("home"===s?"imgs/cart-w.svg":"imgs/cart(2).svg"," alt='cart'></div>\n          </div>\n          \n           \n            </div>");n.append(r)}));case 2:case"end":return e.stop()}}),e)})))).apply(this,arguments)}var w=$(".icon-minus"),y=$(".icon-plus"),x=$(".quantity .number");function b(e){var n=+x.text();e?x.text(++n):n&&x.text(--n)}function C(e){var n=e[0].colors,s=e[1].selectedimg,t=s.src,a=s.srcset,c=s.name,i=s.deg;n.map((function(e){var n=e.backgroundColor,s=e.name,t=e.deg,a="background-color:".concat(n),c="<div id=".concat(s,">\n            <div class='slider-item' data-name=").concat(s," data-deg=").concat(t,"  style=").concat(a,'>\n                             <span class="name">').concat(s,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>\n            </div>");g.append(c)}));var r="<div>\n        <div class='slider-item latte-img' data-name=".concat(c," data-deg=").concat(i," >\n                                <img src=").concat(t,"\n                                alt=").concat(c,"\n                                srcset=").concat(a,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(c,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n                         </div>\n        </div>");g.find("#Truffle").after(r),g.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]});var o=$(".colors-types .slider-item");o.on("click",(function(){$(this).hasClass("select")?$(this).removeClass("select"):(o.removeClass("select"),$(this).addClass("select"))}))}function S(e){var n=$(".lipsStick .slick-slider");e.map((function(e){var s=e.src,t=e.srcset,a="<div class='slider-item'>\n            <img src=".concat(s,"\n            srcset=").concat(t,"\n           />\n           </div>");n.append(a)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}function T(e){var n=$(".related-item .slick-slider");h(n,e),f(n,3.5)}function j(n){var s=$(".sellings .slick-slider");h(s,n),f(s,4.2),e=$(".sellings .slick-slider .cart"),console.log(e)}function I(e){var n=$(".categories .category-list");e.map((function(e){var s=e.src,t=e.name,a="<li class=\"category-item list-item\">\n                            <a class='list-link link'>\n                            <img src=".concat(s," alt=").concat(t,">\n                            <span class='name'>").concat(t,"</span>\n                            </a>\n                          </li>");n.append(a)}))}function G(){return(G=_asyncToGenerator(regeneratorRuntime.mark((function e(){var n;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return console.log("in ajax"),e.next=3,$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(e){var n=e.lips,t=e.lipstickimgs,a=e.relateditems,c=e.bestItems,i=e.categories;"pdp"===s?(C(n),S(t),T(a)):"home"===s&&(j(c),I(i))},error:function(e,n,s){}});case 3:return n=e.sent,e.abrupt("return",n);case 5:case"end":return e.stop()}}),e)})))).apply(this,arguments)}!function(){G.apply(this,arguments)}();v(),$(window).on("resize",(function(){v(),m()})),$(window).on("scroll",(function(){d.hasClass("expand")&&i.click(),$(this).scrollTop()>150?(c.addClass("d-none"),m()):(c.removeClass("d-none"),m())})),w.on("click",(function(){return b(!1)})),y.on("click",(function(){return b(!0)})),$(".sellings .slick-slider").on("mouseenter",".cart",(function(){$(this).find("img").attr("src","imgs/cart-added.svg")})),$(".sellings .slick-slider").on("mouseleave",".cart",(function(){$(this).find("img").attr("src","imgs/cart-w.svg")}))}));
