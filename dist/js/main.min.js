"use strict";function asyncGeneratorStep(n,e,s,t,c,a,i){try{var r=n[a](i),o=r.value}catch(n){return void s(n)}r.done?e(o):Promise.resolve(o).then(t,c)}function _asyncToGenerator(n){return function(){var e=this,s=arguments;return new Promise((function(t,c){var a=n.apply(e,s);function i(n){asyncGeneratorStep(a,t,c,i,r,"next",n)}function r(n){asyncGeneratorStep(a,t,c,i,r,"throw",n)}i(void 0)}))}}$((function(){$("header");var n,e,s=$("body").attr("id"),t=$(".header .header-content"),c=$(".lower-header"),a=$(".upper-header"),i=$(".hamburger-icon"),r=$(".lower-header .nav-item .nav-link"),o=($(".link-search"),$("#menu .nav-list a")),l=$("#menu"),d=($(".out-lcontainer"),$(".home-products-li"),$(".product-select"),!1);function m(){e=t.innerHeight(),c.innerHeight(),a.innerHeight(),l.innerWidth(),l.innerWidth()}function u(){m(),l.css("top",e)}function p(){m(),$("body").css("padding-top",e),window.innerWidth<768&&(!d&&(d=!0,$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,menuWidth:"100%",overlapWidth:0,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:"",preventItemClick:!1,preventGroupItemClick:!1,direction:"ltr",swipe:"none"}),$("#menu").multilevelpushmenu("collapse")),$("#menu").multilevelpushmenu("redraw"),u())}r.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),i.on("click",(function(){l.toggleClass("expand"),$("#menu").hasClass("expand")?$("#menu").multilevelpushmenu("expand"):$("#menu").multilevelpushmenu("collapse"),$(".menu-hide").toggleClass("d-none")}));var v=$(".colors-types .slick-slider");function g(n,e){n.slick({slidesToShow:e,slidesToScroll:1,arrows:!1,dots:!1,cssEase:!0,infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:2.5}},{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:2.1,slidesToScroll:1}}]})}function f(n,e){return h.apply(this,arguments)}function h(){return(h=_asyncToGenerator(regeneratorRuntime.mark((function n(e,t){return regeneratorRuntime.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,t.map((function(n){var t=n.src,c=n.name,a=n.mark,i=n.mobilemark,r=n.type,o='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'><img class="img" src='.concat(t,"   alt=").concat(c,'></div>\n            <div class="card-body">\n            <a href="#" class="card-title name link">').concat(c,'</a>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle type">').concat(r,'</h6>\n              <p class="desc d-none d-md-flex">').concat(a,'</p>\n              <p class="desc d-flex d-md-none">').concat(i,"</p>\n            </div>\n           \n          \n            <div class='cart icon d-none d-md-block'><img src=").concat("home"===s?"imgs/cart-w.svg":"imgs/cart(2).svg"," alt='cart'></div>\n            <div class='cart icon d-block d-md-none'><img src=").concat("home"===s?"imgs/cart-w.svg":"imgs/mobile/pdp/cart-m.svg"," alt='cart'></div>\n\n          </div>\n          \n           \n            </div>");e.append(o)}));case 2:case"end":return n.stop()}}),n)})))).apply(this,arguments)}var k=$(".icon-minus"),w=$(".icon-plus"),y=$(".quantity .number");function x(n){var e=+y.text();n?y.text(++e):e&&y.text(--e)}function b(n){var e=n[0].colors,s=n[1].selectedimg,t=s.src,c=s.srcset,a=s.name,i=s.deg;e.map((function(n){var e=n.backgroundColor,s=n.name,t=n.deg,c="background-color:".concat(e),a="<div id=".concat(s,">\n            <div class='slider-item' data-name=").concat(s," data-deg=").concat(t,"  style=").concat(c,'>\n                             <span class="name d-none d-md-flex">').concat(s,'</span>\n                             <div class=\'selected-container d-none d-md-flex\'>\n                             <img src="imgs/selected.jpg"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>\n            </div>");v.append(a)}));var r="<div>\n        <div class='slider-item latte-img' data-name=".concat(a," data-deg=").concat(i," >\n                                <img src=").concat(t,"\n                                alt=").concat(a,"\n                                srcset=").concat(c,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name d-none d-md-flex">').concat(a,'</span>\n                                    <div class=\'selected-container d-none d-md-flex\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n                         </div>\n        </div>");v.find("#Truffle").after(r),v.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!1,slidesToScroll:1}}]});var o=$(".colors-types .slider-item");o.on("click",(function(){$(this).hasClass("select")?$(this).removeClass("select"):(o.removeClass("select"),$(this).addClass("select"))}))}function C(n){var e=$(".lipsStick .slick-slider");n.map((function(n){var s=n.src,t=n.srcset,c="<div class='slider-item'>\n           <div class=\"img-container\">\n           <img src=".concat(s,"\n           srcset=").concat(t,"\n          />\n           </div>\n           </div>");e.append(c)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}function S(n){var e=$(".related-item .slick-slider");f(e,n),g(e,3.5)}function T(e){var s=$(".sellings .slick-slider");f(s,e),g(s,4.2),n=$(".sellings .slick-slider .cart"),console.log(n)}function j(n){var e=$(".categories .category-list");n.map((function(n){var s=n.src,t=n.name,c="<li class=\"category-item list-item\">\n                            <a class='list-link link'>\n                            <img src=".concat(s," alt=").concat(t,">\n                            <span class='name'>").concat(t,"</span>\n                            </a>\n                          </li>");e.append(c)}))}function G(){return(G=_asyncToGenerator(regeneratorRuntime.mark((function n(){var e;return regeneratorRuntime.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return console.log("in ajax"),n.next=3,$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(n){var e=n.lips,t=n.lipstickimgs,c=n.relateditems,a=n.bestItems,i=n.categories;"pdp"===s?(b(e),C(t),S(c)):"home"===s&&(T(a),j(i))},error:function(n,e,s){}});case 3:return e=n.sent,n.abrupt("return",e);case 5:case"end":return n.stop()}}),n)})))).apply(this,arguments)}!function(){G.apply(this,arguments)}();p(),$(window).on("resize",(function(){p(),u()})),$(window).on("scroll",(function(){$(this).scrollTop()>150?(a.addClass("d-none"),u()):(a.removeClass("d-none"),u())})),k.on("click",(function(){return x(!1)})),w.on("click",(function(){return x(!0)})),$(".sellings .slick-slider").on("mouseenter",".cart",(function(){$(this).find("img").attr("src","imgs/cart-added.svg")})),$(".sellings .slick-slider").on("mouseleave",".cart",(function(){$(this).find("img").attr("src","imgs/cart-w.svg")}))}));
