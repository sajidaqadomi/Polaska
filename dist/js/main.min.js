"use strict";function asyncGeneratorStep(e,n,s,t,c,a,i){try{var r=e[a](i),o=r.value}catch(e){return void s(e)}r.done?n(o):Promise.resolve(o).then(t,c)}function _asyncToGenerator(e){return function(){var n=this,s=arguments;return new Promise((function(t,c){var a=e.apply(n,s);function i(e){asyncGeneratorStep(a,t,c,i,r,"next",e)}function r(e){asyncGeneratorStep(a,t,c,i,r,"throw",e)}i(void 0)}))}}$((function(){$("header");var e,n,s=$("body").attr("id"),t=$(".header .header-content"),c=$(".lower-header"),a=$(".upper-header"),i=$(".hamburger-icon"),r=$(".lower-header .nav-item .nav-link"),o=($(".link-search"),$("#menu .nav-list a")),l=$("#menu"),d=($(".out-lcontainer"),$(".home-products-li"),$(".product-select"),!1);function m(){n=t.innerHeight(),c.innerHeight(),a.innerHeight(),l.innerWidth(),l.innerWidth()}function u(){m(),l.css("top",n)}function p(){m(),$("body").css("padding-top",n),window.innerWidth<768&&(!d&&(d=!0,$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!0,menuWidth:"100%",overlapWidth:0,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:"",preventItemClick:!1,preventGroupItemClick:!1,direction:"ltr",swipe:"none"}),$("#menu").multilevelpushmenu("collapse")),$("#menu").multilevelpushmenu("redraw"),u())}r.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),i.on("click",(function(){l.toggleClass("expand"),$("#menu").hasClass("expand")?$("#menu").multilevelpushmenu("expand"):$("#menu").multilevelpushmenu("collapse"),$(".menu-hide").toggleClass("d-none")}));var v=$(".colors-types .slick-slider");function g(e,n){e.slick({slidesToShow:n,slidesToScroll:1,arrows:!1,dots:!1,cssEase:!0,infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:2.5}},{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:2.1,slidesToScroll:1}}]})}function f(e,n){return h.apply(this,arguments)}function h(){return(h=_asyncToGenerator(regeneratorRuntime.mark((function e(n,t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,t.map((function(e){var t=e.src,c=e.name,a=e.mark,i=e.mobilemark,r=e.type,o='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'><img class="img" src='.concat(t,"   alt=").concat(c,'></div>\n            <div class="card-body">\n            <a href="#" class="card-title name link">').concat(c,'</a>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle type">').concat(r,'</h6>\n              <p class="desc d-none d-md-flex">').concat(a,'</p>\n              <p class="desc d-flex d-md-none">').concat(i,"</p>\n            </div>\n           \n          \n            <div class='cart icon d-none d-md-block'><img src=").concat("home"===s?"imgs/cart-w.svg":"imgs/cart(2).svg"," alt='cart'></div>\n            <div class='cart icon d-block d-md-none'><img src=").concat("home"===s?"imgs/cart-w.svg":"imgs/mobile/pdp/cart-m.svg"," alt='cart'></div>\n\n          </div>\n          \n           \n            </div>");n.append(o)}));case 2:case"end":return e.stop()}}),e)})))).apply(this,arguments)}var k=$(".icon-minus"),w=$(".icon-plus"),y=$(".quantity .number");function x(e){var n=+y.text();e?y.text(++n):n&&y.text(--n)}function b(e){var n=e[0].colors,s=e[1].selectedimg,t=s.src,c=s.srcset,a=s.name,i=s.deg;n.map((function(e){var n=e.backgroundColor,s=e.name,t=e.deg,c="background-color:".concat(n),a="<div id=".concat(s,">\n            <div class='slider-item' data-name=").concat(s," data-deg=").concat(t,"  style=").concat(c,'>\n                             <span class="color-name d-none d-md-flex">').concat(s,'</span>\n                             <div class=\'selected-container d-none d-md-flex\'>\n                             <img src="imgs/selected.jpg"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>\n            </div>");v.append(a)}));var r="<div>\n        <div class='slider-item latte-img' data-name=".concat(a," data-deg=").concat(i," >\n                                <img src=").concat(t,"\n                                alt=").concat(a,"\n                                srcset=").concat(c,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name d-none d-md-flex">').concat(a,'</span>\n                                    <div class=\'selected-container d-none d-md-flex\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n                         </div>\n        </div>");v.find("#Truffle").after(r),v.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!1,slidesToScroll:1,swipe:!0}}]});var o=$(".colors-types .slider-item");o.on("click",(function(){$(this).hasClass("select")?$(this).removeClass("select"):(o.removeClass("select"),$(this).addClass("select"))}))}function C(e){var n=$(".lipsStick .slick-slider");e.map((function(e){var s=e.src,t=e.srcset,c="<div class='slider-item'>\n           <div class=\"img-container\">\n           <img src=".concat(s,"\n           srcset=").concat(t,"\n          />\n           </div>\n           </div>");n.append(c)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}function S(e){var n=$(".related-item .slick-slider");f(n,e),g(n,3.5)}function T(n){var s=$(".sellings .slick-slider");f(s,n),g(s,4.2),e=$(".sellings .slick-slider .cart"),console.log(e)}function j(e){var n=$(".categories .category-list");e.map((function(e){var s=e.src,t=e.name,c="<li class=\"category-item list-item\">\n                            <a class='list-link link'>\n                            <img src=".concat(s," alt=").concat(t,">\n                            <span class='name'>").concat(t,"</span>\n                            </a>\n                          </li>");n.append(c)}))}function G(){return(G=_asyncToGenerator(regeneratorRuntime.mark((function e(){var n;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return console.log("in ajax"),e.next=3,$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(e){var n=e.lips,t=e.lipstickimgs,c=e.relateditems,a=e.bestItems,i=e.categories;"pdp"===s?(b(n),C(t),S(c)):"home"===s&&(T(a),j(i))},error:function(e,n,s){}});case 3:return n=e.sent,e.abrupt("return",n);case 5:case"end":return e.stop()}}),e)})))).apply(this,arguments)}!function(){G.apply(this,arguments)}();p(),$(window).on("resize",(function(){p(),u()})),$(window).on("scroll",(function(){$(this).scrollTop()>150?(a.addClass("d-none"),u()):(a.removeClass("d-none"),u())})),k.on("click",(function(){return x(!1)})),w.on("click",(function(){return x(!0)})),$(".sellings .slick-slider").on("mouseenter",".cart",(function(){$(this).find("img").attr("src","imgs/cart-added.svg")})),$(".sellings .slick-slider").on("mouseleave",".cart",(function(){$(this).find("img").attr("src","imgs/cart-w.svg")}))}));
