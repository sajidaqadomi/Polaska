"use strict";function asyncGeneratorStep(n,e,s,t,c,a,i){try{var r=n[a](i),o=r.value}catch(n){return void s(n)}r.done?e(o):Promise.resolve(o).then(t,c)}function _asyncToGenerator(n){return function(){var e=this,s=arguments;return new Promise((function(t,c){var a=n.apply(e,s);function i(n){asyncGeneratorStep(a,t,c,i,r,"next",n)}function r(n){asyncGeneratorStep(a,t,c,i,r,"throw",n)}i(void 0)}))}}$((function(){$("header");var n,e,s,t=$("body").attr("id"),c=$(".header .header-content"),a=$(".lower-header"),i=$(".upper-header"),r=$(".hamburger-icon"),o=$(".lower-header .nav-item .nav-link"),l=$(".link-search"),d=$("#menu .nav-list a"),p=$("#menu");$(".out-lcontainer"),$(".home-products-li"),$(".product-select");function u(){e=c.innerHeight(),a.innerHeight(),i.innerHeight(),s=p.innerWidth(),s=p.innerWidth()}function m(){u(),p.css("top",e)}function v(){p.animate({left:"".concat(p.hasClass("show")?0:-s)},100)}function g(){u(),$("body").css("padding-top",e),p.css("left",-s),window.innerWidth<768&&(!0,$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),p.css("left",-s),m(),v())}o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),d.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),r.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),p.toggleClass("show"),v(),$(this).find(".icon").hasClass("fa-arrow-left")?l.fadeOut(100):l.fadeIn(100)}));var f=$(".colors-types .slick-slider");function h(n,e){n.slick({slidesToShow:e,slidesToScroll:1,arrows:!1,dots:!1,cssEase:!0,infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:2.5}},{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:1.5,slidesToScroll:1}}]})}function k(n,e){return w.apply(this,arguments)}function w(){return(w=_asyncToGenerator(regeneratorRuntime.mark((function n(e,s){return regeneratorRuntime.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,s.map((function(n){var s=n.src,c=n.name,a=n.mark,i=n.type,r='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'><img class="img" src='.concat(s,"   alt=").concat(c,'></div>\n            <div class="card-body">\n            <a href="#" class="card-title name link">').concat(c,'</a>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle type">').concat(i,'</h6>\n              <p class="desc">').concat(a,"</p>\n            </div>\n           \n          \n            <div class='cart icon'><img src=").concat("home"===t?"imgs/cart-w.svg":"imgs/cart(2).svg"," alt='cart'></div>\n          </div>\n          \n           \n            </div>");e.append(r)}));case 2:case"end":return n.stop()}}),n)})))).apply(this,arguments)}var y=$(".icon-minus"),x=$(".icon-plus"),b=$(".quantity .number");function C(n){var e=+b.text();n?b.text(++e):e&&b.text(--e)}function S(n){var e=n[0].colors,s=n[1].selectedimg,t=s.src,c=s.srcset,a=s.name,i=s.deg;e.map((function(n){var e=n.backgroundColor,s=n.name,t=n.deg,c="background-color:".concat(e),a="<div id=".concat(s,">\n            <div class='slider-item' data-name=").concat(s," data-deg=").concat(t,"  style=").concat(c,'>\n                             <span class="name">').concat(s,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>\n            </div>");f.append(a)}));var r="<div>\n        <div class='slider-item latte-img' data-name=".concat(a," data-deg=").concat(i," >\n                                <img src=").concat(t,"\n                                alt=").concat(a,"\n                                srcset=").concat(c,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(a,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n                         </div>\n        </div>");f.find("#Truffle").after(r),f.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]});var o=$(".colors-types .slider-item");o.on("click",(function(){$(this).hasClass("select")?$(this).removeClass("select"):(o.removeClass("select"),$(this).addClass("select"))}))}function T(n){var e=$(".lipsStick .slick-slider");n.map((function(n){var s=n.src,t=n.srcset,c="<div class='slider-item'>\n            <img src=".concat(s,"\n            srcset=").concat(t,"\n           />\n           </div>");e.append(c)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}function j(n){var e=$(".related-item .slick-slider");k(e,n),h(e,3.5)}function G(e){var s=$(".sellings .slick-slider");k(s,e),h(s,4.2),n=$(".sellings .slick-slider .cart"),console.log(n)}function I(n){var e=$(".categories .category-list");n.map((function(n){var s=n.src,t=n.name,c="<li class=\"category-item list-item\">\n                            <a class='list-link link'>\n                            <img src=".concat(s," alt=").concat(t,">\n                            <span class='name'>").concat(t,"</span>\n                            </a>\n                          </li>");e.append(c)}))}function H(){return(H=_asyncToGenerator(regeneratorRuntime.mark((function n(){var e;return regeneratorRuntime.wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return console.log("in ajax"),n.next=3,$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(n){var e=n.lips,s=n.lipstickimgs,c=n.relateditems,a=n.bestItems,i=n.categories;"pdp"===t?(S(e),T(s),j(c)):"home"===t&&(G(a),I(i))},error:function(n,e,s){}});case 3:return e=n.sent,n.abrupt("return",e);case 5:case"end":return n.stop()}}),n)})))).apply(this,arguments)}!function(){H.apply(this,arguments)}();g(),$(window).on("resize",(function(){g(),m()})),$(window).on("scroll",(function(){p.hasClass("show")&&r.click(),$(this).scrollTop()>150?(i.addClass("d-none"),m()):(i.removeClass("d-none"),m())})),y.on("click",(function(){return C(!1)})),x.on("click",(function(){return C(!0)})),$(".sellings .slick-slider").on("mouseenter",".cart",(function(){$(this).find("img").attr("src","imgs/cart-added.svg")})),$(".sellings .slick-slider").on("mouseleave",".cart",(function(){$(this).find("img").attr("src","imgs/cart-w.svg")}))}));
